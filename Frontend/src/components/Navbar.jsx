...
function Navbar() {
  ...
  const linkStyle = ({ isActive }) =>
    isActive ? "bg-white text-black px-3 py-1 rounded" : "hover:text-gray-300";
  ...
  return (
    <nav className="bg-black text-white px-8 py-4 flex justify-between items-center">
      ...
      <div className="flex gap-5 items-center">
        ...
        <NavLink to="/submit-complaint" className={linkStyle}>
          Submit
        </NavLink>
        <NavLink to="/my-complaints" className={linkStyle}>
          My Complaints
        </NavLink>
